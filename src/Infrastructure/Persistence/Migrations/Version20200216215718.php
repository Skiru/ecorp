 ...
 */
final class Version20200216215718 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, uuid UUID NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) DEFAULT NULL, age INT NOT NULL, avatar_uri VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
